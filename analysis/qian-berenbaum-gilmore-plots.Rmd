...
p_mental_rot_scatters_annotated <- p_boxplots + plot_annotation(tag_levels = "A")
...
ggsave(
  plot = p_vision_aug,
  filename = "paper_figs/fig-03-contrast-motion-alt.jpg",
  units = "in",
  width = 3.4375,
  dpi = 600
)
...
ggsave(
  ...
  filename = "paper_figs/fig-S01-mental-rot-interests-alt.jpg",
  units = "in",
  width = 3.4375,
  dpi = 600  
)
