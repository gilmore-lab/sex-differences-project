...
## Run computer task visualization summaries

Choose:

1. Unique sub_ids for each task (remove duplicates, if any).
2. Files that have `enough_trials` and `has_key_vars` values `==TRUE`
