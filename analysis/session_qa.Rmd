...
params:
  ...
  qualtrics_csv_dir: "~/Box Sync/Project_Sex_difference_on_Motion_Perception/data/qualtrics_survey_data/csv"
...
```{r}
qualtrics_fns <- list.files(params$qualtrics_csv_dir, pattern = "\\.csv$", full.names = TRUE)
...
There are `r dim(demog_df)[1]` Qualtrics datasets.
