...
```{r}
df1$m<-df1$masscale-df1$femscale
```

# calculate alpha
```{r}
feshob<-data.frame(hobby[,c(4,9,10,15,16,20,21,22,38,44,46,51,54,56,57,60,61),])
psych::alpha(feshob)
mashob<-data.frame(hobby[,c(2,7,12,18,19,23,24,25,29,32,34,35,36,42,43,45,49,58,59)])
psych::alpha(mashob)
```
