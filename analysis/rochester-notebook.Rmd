...
```{r}
s1 <- readr::read_csv("~/Box/Project_Sex_difference_on_Motion_Perception/data/passed_qa/20191118083974_motion_temporal_threshold.csv")
```

And a second who is very consistent: 2019112209583295

```{r}
s2 <- readr::read_csv("~/Box/Project_Sex_difference_on_Motion_Perception/data/passed_qa/2019112209583295_motion_temporal_threshold.csv")
```
...
```{r}
motion_fl <- list.files("~/Box/Project_Sex_difference_on_Motion_Perception/data/passed_qa", pattern = "motion", full.names = TRUE)
...
contrast_fl <- list.files("~/Box/Project_Sex_difference_on_Motion_Perception/data/passed_qa", pattern = "contrast", full.names = TRUE)
```
