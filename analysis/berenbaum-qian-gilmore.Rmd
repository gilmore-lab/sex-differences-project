...
```{r}
df_trimmed <- df1[-all_outliers[['log_motion']],]
```
...
Do the trimmed data show the stronger relationship between vision and mental rotation than sex and mental rotation?
