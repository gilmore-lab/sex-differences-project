...
Median log(motion duration) thresholds are larger in females than males. This means that females were less sensitive to motion.
...
Females had fewer correct trials than males. This is shown by the effect size.
...
Our preregistered plan described testing for sex differences in male-typed hobbies. We have chosen not to describe the hobbies data in this report.
...
We estimate the correlation between mental_rotation and log contrast thresholds in females as follows: `r es_mental_rot_contrast$formatted_r`.
...
Contrast thresholds do not significantly correlate with mental rotation scores in males. 
...
We estimate the correlation between mental_rotation and log contrast thresholds in males as follows: `r es_mental_rot_contrast$formatted_r`.
...
Log(motion duration) thresholds (negatively) correlate with mental rotation scores in females. This means that lower thresholds (higher sensitivity) is associated with better performance in the mental rotation task.
...
We estimate the correlation between mental_rotateion and log motion thresholds in females as follows: `r es_mental_rot_motion$formatted_r`.
...
Motion duration thresholds do not correlate with mental rotation scores in males.
...
We estimate the correlation between mental_rotation and log motion thresholds in males as follows: `r es_mental_rot_motion$formatted_r`
...
We estimate the correlation between log contrast and log motion thresholds in females as follows: `r es_contrast_motion$formatted_r`.
...
We estimate the correlation between log contrast and log motion thresholds in males as follows: `r es_contrast_motion$formatted_r`.
...
Females still have larger motion duration threshold than males.
...
Log(motion duration) thresholds (negatively) correlate with mental rotation scores in females, even after trimming. 
...
The vision measures now correlate in females.
...
We find that a correlation between log contrast and log motion thresholds in females is as follows: `r es_contrast_motion$formatted_r`.
...
The vision measures still correlate in males.
