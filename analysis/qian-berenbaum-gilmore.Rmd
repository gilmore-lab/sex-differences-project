...
```{r, child="qian-berenbaum-gilmore-plots.Rmd"}
```
...
```{r, child='relative-weight-analysis.Rmd'}
```
...
Determine which hobbies are strongly female-typed according to (Lippa, 1991)
...
Dancing</br>
going to art galleries</br>
going to church groups</br>
writing poetry</br>
trying new fashions</br>
aerobics</br>
travelling</br>
talking on phone with friends</br>
clothes shopping</br>
romance novels</br>
singing</br>
photography</br>
going to formal dress affairs</br>
cooking</br>
going to shows and plays</br>
knitting</br>
romance movies</br>
going out to dinner with friends</br>
going to museums</br>
house plants</br>
collecting stuffed animals</br>
...
alpha_female_type_interests <- psych::alpha(f_interest_vars)

# m_interest_vars <- interest_vars[, !( names(interest_vars) %in% f_typed_interests )]
# alpha_male_type_interests <- psych::alpha(m_interest_vars)
```

Determine which hobbies are strongly male-typed according to (Lippa, 1991):
