...
```{r}
library("gridExtra")
p = grid.arrange(ncol = 2, nrow = 1, p1, p_aug)
ggsave(
  plot = p,
  filename = paste0("~/Desktop/fig2.jpg"),
  units = "in",
  height = 6,
  width = 12,
  dpi = 600
...
ggsave(
  plot = p_aug2,
  filename = paste0("~/Desktop/fig3.jpg"),
  units = "in",
  height = 6,
  width = 6,
  dpi = 600
...
We conducted a Relative Weight Analysis that is described in a separate file <relative-weight-analysis.html>.
...
```
=======
>>>>>>> 4f2c0112020748ab2321798dec226007b29eae82
