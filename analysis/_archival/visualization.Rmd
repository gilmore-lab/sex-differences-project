      ...
      stat_smooth(
       # color="black",  
        method = "lm", 
                  ...
                  na.rm = TRUE) +
      geom_point(size=2
            #  , position = position_jitterdodge(jitter.width = 0.1, dodge.width=0,seed=2)
                ,alpha=0.6
            ,lwd=2
            #     ,shape=21
                 ) +
...
#   scale_color_brewer(direction = -1) +
 #   scale_fill_manual( values =alpha(c("black","white"),0.2)) +
      annotate(
        ...
        y = any,
        size=6,
        label = c(an_f, an_m),col=c( "slateblue3","indianred2"),
             hjust = 1)
...
sex_diff_scatter_13 <-
  ...
  #     linetype = Sex,
      ...
      scale_color_manual(values=c("purple4", "green4"))+
      xlab(x_var) +
      ylab(y_var) +
      stat_smooth(
       # color="black",  
...
#   scale_color_brewer(direction = -1) +
 #   scale_fill_manual( values =alpha(c("black","white"),0.2)) +
      annotate(
        ...
        y = any,
        size=6,
        label = c(an_f, an_m),col=c("purple4", "green4"),
             hjust = 1)
...
<<<<<<< HEAD:analysis/visualization.Rmd
      scale_color_manual(values=c("navy", "darkorange3"))+
=======
      scale_color_manual(values=c("blue3", "darkorange3"))+
>>>>>>> 08c3719346017c97c62b9849536d150a35bd3ff6:analysis/_archival/visualization.Rmd
      xlab(x_var) +
      ylab(y_var) +
      stat_smooth(
       # color="black",  
...
#   scale_color_brewer(direction = -1) +
 #   scale_fill_manual( values =alpha(c("black","white"),0.2)) +
      annotate(
        ...
        size=6,
<<<<<<< HEAD:analysis/visualization.Rmd
        label = c(an_f, an_m),col=c("navy", "darkorange3"),
=======
...
ggsave(
  plot = p_aug2,
  filename = paste0("C:/Users/yimin/OneDrive/Desktop/fig3_11_darksj.jpg"),
  units = "in",
  height = 6,
  width = 6,
  dpi = 600
