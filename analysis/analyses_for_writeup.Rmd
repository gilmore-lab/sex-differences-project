...
params:
  ...
  csv_fn: "combined_2021-03-04.csv"
...
```{r}
psych::describe(df1 %>% filter(Sex=="Males"))
psych::describe(df1 %>% filter(Sex=="Females"))  
```
...
cor.test(df_complete_F$log_contrast, df_complete_F$Interests, method = "pearson", alternative = "less")
cor.test(df_complete_F$log_motion, df_complete_F$mental_rot, method = "pearson", alternative = "less")
cor.test(df_complete_F$log_motion, df_complete_F$Interests, method = "pearson", alternative = "less")
```

### Males
```{r}
cor.test(df_complete_M$log_contrast,df_complete_M$mental_rot, method = "pearson", alternative = "less")
cor.test(df_complete_M$log_contrast, df_complete_M$Interests, method = "pearson", alternative = "less")
cor.test(df_complete_M$log_motion, df_complete_M$mental_rot, method = "pearson", alternative = "less")
cor.test(df_complete_M$log_motion, df_complete_M$Interests, method = "pearson", alternative = "less")
```
### Females
...
df_test<-rbind(df_complete_M, df_complete_F)
