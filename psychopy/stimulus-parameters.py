...
# stim_diam_degs = [1.8, 3.6, 7.2] # deg to compare with Murray et al. 2018
...
# variable duration controlled by a Psi adaptivestaircase procedure (a trapezoidal temporal
...
# Constant parameters
# view_distance_cm = 60
# stim_duration_secs = Psi adaptivestaircase algorithm (80% accuracy)
# surround_diam_degs = [13,13]
# grating_phase = 0
