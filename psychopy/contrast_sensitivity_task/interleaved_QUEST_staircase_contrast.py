...
expInfo['frameRate'] = 1  # 1HZ, orginal: win.getActualFrameRate()
...
instrText = visual.TextStim(win=win, name='instrText',
    text="The display you see may move in vertical or horizontal direction. Press RIGHT or LEFT button if you see it is moving horizontally. Press UP or DOWN button if you see it is moving vertically. \n \nIf you don't see anything then guess! \n \n \nPress any key to continue",
    font='Arial',
