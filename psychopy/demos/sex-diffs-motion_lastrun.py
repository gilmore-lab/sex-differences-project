...
expName = 'sex-diffs-motion'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/rick/github/gilmore-lab/sex-differences-in-motion-perception/psychopy/sex-diffs-motion_lastrun.py',
