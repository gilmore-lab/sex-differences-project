...
- Move back up one line and ask the participant to identify all the optotypes on that line. If the participants identifies all symbols correctly, go to the ext line with smaller optotypes and ask the child to identify all optotypes on the line.
