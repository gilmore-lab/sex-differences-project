...
>"*Thank you. Now we'd like to move on to the questionnaire portion of the study. Are you ready?*"
...
The order of the computer experiments will be randomized across participants in Qualtrics
- run the Murray et al. task first
- run the Abramov et al. task first.
