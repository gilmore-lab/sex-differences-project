...
4. Researchers will be contacted by a google calendar invitation if they are needed for a slot that is not part of their regularly scheduled lab time.
...
- Output data files are stored here: /Documents/PsychoPy-Stimuli/**STUDY NAME**/csv
...
To view an example, visit [this link](analysis/session_qa.html).
